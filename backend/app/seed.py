...
async def ensure_runtime_schema(db: AsyncSession) -> None:
    ...
    statements = [
        ...
        "ALTER TABLE guardian ADD COLUMN IF NOT EXISTS annual_income NUMERIC(14,2)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS father_occupation VARCHAR(150)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS father_annual_income NUMERIC(14,2)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS mother_occupation VARCHAR(150)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS mother_annual_income NUMERIC(14,2)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS guardian_name VARCHAR(150)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS guardian_phone VARCHAR(32)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS guardian_relation VARCHAR(50)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS guardian_occupation VARCHAR(150)",
        "ALTER TABLE admission_lead ADD COLUMN IF NOT EXISTS guardian_annual_income NUMERIC(14,2)",
        ...
        "ALTER TABLE question_bank_item ADD COLUMN IF NOT EXISTS options JSON",
        "ALTER TABLE question_bank_item ADD COLUMN IF NOT EXISTS explanation TEXT",
        "ALTER TABLE question_bank_item ADD COLUMN IF NOT EXISTS created_by_employee_id UUID",
