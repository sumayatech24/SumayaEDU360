...
| 2 | Student | Student information system | Student insights | E2E core / AI partial | Typed Student/Guardian records, Student 360, portal scoping, medical/consent vault, guarded transfer/withdrawal/TC, re-enrollment, alumni guard and duplicate detection | Reviewed complex-history merge and richer insight review |
...
| 8 | Finance | Fee management | Fee default prediction | E2E core / AI partial | Plans/components/installments, bulk assignment, aid/scholarship, invoices, dues/reminders, payments, refund approval and cashier close | Configurable aging escalation and richer default prediction |
| 9 | Finance | Online payments | Payment assistant | Partial | Payment records, provider-reference reconciliation, mismatch/unmatched handling and processed refunds | Live provider checkout plus signed/idempotent webhooks |
